<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	con=DriverManager.getConnection("jdbc:mysql://localhost:3306/pizza?useSSL=false&serverTimezone=UTC","root","");
    %>
<html>
<head>
...
document.changepwd.submit();
            ...
            <a href="billing.html">My orders</a>
            <a href="mycart.html" >My cart</a>
            <a class="active" href="#" >Change password</a>
            <a href="#" >Logout</a>
            </div>
			<% String query="select * from pizza.user where email='"+uname+"'";
